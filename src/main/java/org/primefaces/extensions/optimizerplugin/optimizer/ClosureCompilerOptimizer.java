...
public class ClosureCompilerOptimizer extends AbstractOptimizer {
	...
	protected Compiler compile(Log log, List<SourceFile> interns, CompilerOptions options, boolean failOnWarning)
		...
		try {
			...
			throw new MojoExecutionException("Geht nicht", e);
		}
	...
	private File setupSourceMapFile(CompilerOptions options,
		org.primefaces.extensions.optimizerplugin.model.SourceMap sourceMap, String outputFilePath)
		throws IOException {
